...
define('TEXT_PRODUCTS_QUANTITY', 'Cantidad del Producto en Stock:');
...
// Products and Discount Copy Options
  define('TEXT_COPY_DISCOUNTS_ONLY','Sólo usado productos duplicados con descuentos ...');
  ...
  define('TEXT_COPY_ATTRIBUTES_UPDATE', '<strong>Actuelice</strong> con nuevas configuraciones/precios, luego añada otros');
  ...
  define('TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES', 'El Precio del producto aumenta en relación con los atributos:');
  ...
  define('TEXT_PRODUCTS_MIXED', 'Combinación Cant. Mín./Unidad del producto:');

  define('PRODUCTS_PRICE_IS_FREE_TEXT', 'El producto es gratis');
  define('TEXT_PRODUCT_IS_FREE', 'El Producto es Gratis:');
  define('TEXT_PRODUCTS_IS_FREE_PREVIEW', '*El producto esta marcado como GRATIS');
  define('TEXT_PRODUCTS_IS_FREE_EDIT', '*El producto esta marcado como GRATIS');

  define('TEXT_PRODUCT_IS_CALL', 'Producto es Pedir Precio:');
  define('TEXT_PRODUCTS_IS_CALL_PREVIEW', '*El producto esta marcado como PEDIR PRECIO');
  define('TEXT_PRODUCTS_IS_CALL_EDIT', '*El producto esta marcado como PEDIR PRECIO');
...
// meta tags
  ...
  define('TEXT_PRODUCTS_METATAGS_PRODUCTS_NAME_STATUS','<strong>Nombre del producto:</strong>');
