...
$define = [
    ...
    'TEXT_AFTER_EMAIL_INSTRUCTIONS' => '%s emails processed. (Each checkbox indicates 1 recipient. Hover over the checkbox to see the email address.)<br /><br />Watch your mail box (' . EMAIL_FROM . ') for:<UL><LI>a) bounce-back messages</LI><LI>b) email addresses that are no longer good</LI><LI>c) removal requests.</LI></UL>Removals can be processed by editing Customer records in the Admin | Customers menu.',
    'ERROR_NEWSLETTER_TITLE' => 'Error: Newsletter title required',
    'ERROR_NEWSLETTER_MODULE' => 'Error: Newsletter module required',
    'ERROR_PLEASE_SELECT_AUDIENCE' => 'Error: Please select an audience to receive this newsletter',
];
