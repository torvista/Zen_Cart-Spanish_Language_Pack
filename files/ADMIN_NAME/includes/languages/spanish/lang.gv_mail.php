...
$define = [
    ...
    'ERROR_GV_AMOUNT' => '<span class="smallText">Introduzca un número con un punto decimal para fracciones p.ej.: 25.00.</span>',
    'TEXT_AMOUNT_INFO' => '<span class="smallText">' . ERROR_GV_AMOUNT . '</span>',
    'TEXT_HTML_MESSAGE' => 'Mensaje<br>HTML :',
    'TEXT_MESSAGE' => 'Mensaje de<br>Texto',
