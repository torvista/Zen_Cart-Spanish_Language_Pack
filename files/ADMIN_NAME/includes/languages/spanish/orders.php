...
define('HEADING_TITLE_DETAILS', 'Detalles del Pedido');
...
define('TEXT_INFO_SEARCH_DETAIL_FILTER_ORDERS_PRODUCTS', 'Filtro de Búsqueda: ');
...
define('ENTRY_DATE_LAST_UPDATED', 'Fecha Actualizada:');
