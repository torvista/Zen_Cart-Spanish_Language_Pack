...
$define = [
    ...
    'TEXT_EMAIL_SUBJECT_ADMIN_SETTINGS_CHANGED' => 'AVISO: Una opción del Admin ha sido cambiada en la tienda ' . STORE_NAME,//torvista added STORE_NAME
    'TEXT_EMAIL_MESSAGE_ADMIN_SETTINGS_CHANGED' => 'Este es un email automático de su tienda Zen Cart ' . STORE_NAME . ' para avisarle de un cambio en sus opciones administrativas que acaba de ocurrir: ' . "\n\n" . 'NOTA: Las opciones de Admin han sido CAMBIADAS en el módulo [%s]  => por el usuario %s.' . "\n\n" . 'Si no llevó a cabo estos cambios => debería verificar las opciones inmediatamente.' . "\n\n" . 'Si está al corriente con estos cambios => puede ignorar este email.',//torvista added STORE_NAME
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_INSTALLED' => 'Este es un email automático de su tienda Zen Cart ' . STORE_NAME . ' para avisarle de un cambio en sus opciones administrativas que acaba de ocurrir: ' . "\n\n" . 'NOTA: Las opciones de Admin han sido CAMBIADAS. El módulo [%s] ha sido instalado por el usuario %s.' . "\n\n" . 'Si no llevó a cabo estos cambios => debería verificar las opciones inmediatamente.' . "\n\n" . 'Si está al corriente con estos cambios => puede ignorar este email.',//torvista added STORE_NAME
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_REMOVED' => 'Este es un email automático de su tienda Zen Cart ' . STORE_NAME . ' para avisarle de un cambio en sus opciones administrativas que acaba de ocurrir: ' . "\n\n" . 'NOTA: Las opciones de Admin han sido CAMBIADAS. El módulo [%s] ha sido quitado por el usuario %s.' . "\n\n" . 'Si no llevó a cabo estos cambios => debería verificar las opciones inmediatamente.' . "\n\n" . 'Si está al corriente con estos cambios => puede ignorar este email.',//torvista added STORE_NAME
