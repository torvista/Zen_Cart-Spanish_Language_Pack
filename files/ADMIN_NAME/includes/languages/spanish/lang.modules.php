...
$define = [
    ...
    'TEXT_EMAIL_MESSAGE_ADMIN_SETTINGS_CHANGED' => 'Este es un email automático de su tienda Zen Cart para avisarle de un cambio en sus opciones administrativas que acaba de ocurrir: ' . "\n\n" . 'NOTA: Las opciones de Admin han sido CAMBIADAS en el módulo [%s]  => por el usuario %s.' . "\n\n" . 'Si no llevó a cabo estos cambios => debería verificar las opciones inmediatamente.' . "\n\n" . 'Si está al corriente con estos cambios => puede ignorar este email.',
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_INSTALLED' => 'Este es un email automático de su tienda Zen Cart para avisarle de un cambio en sus opciones administrativas que acaba de ocurrir: ' . "\n\n" . 'NOTA: Las opciones de Admin han sido CAMBIADAS. El módulo [%s] ha sido instalado por el usuario %s.' . "\n\n" . 'Si no llevó a cabo estos cambios => debería verificar las opciones inmediatamente.' . "\n\n" . 'Si está al corriente con estos cambios => puede ignorar este email.',
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_REMOVED' => 'Este es un email automático de su tienda Zen Cart para avisarle de un cambio en sus opciones administrativas que acaba de ocurrir: ' . "\n\n" . 'NOTA: Las opciones de Admin han sido CAMBIADAS. El módulo [%s] ha sido quitado por el usuario %s.' . "\n\n" . 'Si no llevó a cabo estos cambios => debería verificar las opciones inmediatamente.' . "\n\n" . 'Si está al corriente con estos cambios => puede ignorar este email.',
