...
$define = [
    ...
    'TABLE_HEADING_PRODUCT' => 'Nombre Producto',
    ...
    'TEXT_SORT_ORDER' => 'Órden',
    'TABLE_HEADING_OPTION_TYPE' => 'Tipo de Opción',
    ...
    'TEXT_WARNING_BACKUP' => '¡Importante: Siempre haga un backup verificado de la base de datos antes de hacer cambios globales!',
    'TEXT_SELECT_OPTION_TYPES_ALLOWED' => 'Nota: no se puede usar las Herramientas Globales con los tipos de opción "Text" o "File".',
    ...
    'TEXT_OPTION_VALUE_ADD_ALL' => 'Actualizar (añadir) todos los Valores de la Opción a TODOS los productos que usar esta Opción',
    'TEXT_INFO_OPTION_VALUE_ADD_ALL' => 'Para TODOS los productos que usan esta Nombre de Opción (y así tienen por lo menos UN valor asignado) => añade TODOS los otros Valores de esta Opción.',
    'TEXT_OPTION_VALUE_ADD_PRODUCT' => 'Actualizar (añadir) todos los otros Valores a UN producto que usa está Nombre de Opción',
    'TEXT_INFO_OPTION_VALUE_ADD_PRODUCT' => 'Para UN producto que usa esta Nombre de Opción (y así tiene por lo menos UN valor asignado) => añade TODOS los otros Valores de esta Opción.',
    'TEXT_OPTION_VALUE_ADD_CATEGORY' => 'Actualizar (añadir) todos los Valores de una Opción a TODOS los productos en a UNA categoría',
    'TEXT_INFO_OPTION_VALUE_ADD_CATEGORY' => 'Para TODOS los productos en UNA categoría => que usan esta Nombre de Opción (y así tienen por lo menos UN valor asignado) => añade TODOS los otros Valores de esta Opción.',
    ...
    'TEXT_COMMENT_OPTION_VALUE_DELETE_ALL' => '<strong>NOTA:</strong> Se eliminará todos los Valores desde los productos. No eliminará los Valores definidos para esa Nombre de Opción.',
    'TEXT_OPTION_VALUE_DELETE_ALL' => 'Borrar todos los Valores de TODOS los productos que usan esta Nombre de Opción',
    ...
    'TEXT_INFO_OPTION_VALUE_DELETE_PRODUCT' => 'Para UN producto que usa esta Nombre de Opción => quita TODOS los Valores/la Opción.',
    ...
    'TEXT_OPTION_VALUE_COPY_ALL' => 'Copiar todos los Valores a otra Nombre de Opción',
    'TEXT_INFO_OPTION_VALUE_COPY_ALL' => 'Todos los Valores de la Opción seleccionada serán copiados/duplicados a otra Nombre de Opción.',
