...
// Products and Attribute Copy Options
  ...
  define('TEXT_COPY_ATTRIBUTES_UPDATE', '<strong>Actualice</strong> con nuevas configuraciones/precios, y luego agregue otros');
  ...
  define('TEXT_PRODUCTS_QTY_BOX_STATUS_PREVIEW', 'Advertencia: No mostrar el cuadro de cantidad, Cdad. por defecto 1');
  define('TEXT_PRODUCTS_QTY_BOX_STATUS_EDIT', 'Advertencia: No mostrar el cuadro de cantidad, Cdad. por defecto 1');
  ...
  define('TEXT_PRODUCTS_QUANTITY_MIN_RETAIL', 'Cdad. Mín. del producto:');
  define('TEXT_PRODUCTS_QUANTITY_UNITS_RETAIL', 'Cdad. de unidades del producto:');
  define('TEXT_PRODUCTS_QUANTITY_MAX_RETAIL', 'Cdad. Máx. del producto:');

  define('TEXT_PRODUCTS_QUANTITY_MAX_RETAIL_EDIT', '0 = Ilimitada, 1 = Sin recuadro de cantidad ni máximo');

  define('TEXT_PRODUCTS_MIXED', 'Cdad. Mín/Unidad combinada del producto:');
  ...
  define('TEXT_PRODUCT_IS_CALL', 'El producto está como llamar por precio:');
  define('TEXT_PRODUCTS_IS_CALL_PREVIEW', '*El producto fue marcado como LLAMAR POR PRECIO');
  define('TEXT_PRODUCTS_IS_CALL_EDIT', '*El produco fue marcado como LLAMAR POR PRECIO');
