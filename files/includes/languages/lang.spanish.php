...
$define = [
    ...
    'BOX_HEADING_FEATURED_CATEGORIES' => 'Categorías Destacadas',
    'BOX_HEADING_FEATURED_PRODUCTS' => 'Productos Destacados',
    ...
    'CART_SHIPPING_QUOTE_CRITERIA' => 'El coste del envío depende de la dirección de entrega:',
    ...
    'ENTRY_CITY_ERROR' => 'La localidad debe tener un mínimo de ' . zen_config('ENTRY_CITY_MIN_LENGTH') . ' caracteres.',
    'ENTRY_CITY_TEXT' => '*',
    ...
    'ENTRY_EMAIL_ADDRESS_ERROR' => 'El e-mail debe tener un mínimo de ' . zen_config('ENTRY_EMAIL_ADDRESS_MIN_LENGTH') . ' caracteres.',
    ...
    'ENTRY_EMAIL_NAME_CHECK_ERROR' => 'El nombre es demasiado corto (precisa un mínimo de ' . zen_config('ENTRY_FIRST_NAME_MIN_LENGTH') . ' caracteres',
    'ENTRY_EMAIL_TEXT_DISPLAY' => 'Solo-TEXTO',
    'ENTRY_ENQUIRY' => 'Mensaje:',
    'ENTRY_FAX_NUMBER' => 'Fax:',
    'ENTRY_FAX_NUMBER_TEXT' => '',
    'ENTRY_FIRST_NAME' => 'Nombre:',
    'ENTRY_FIRST_NAME_ERROR' => 'El nombre debe tener un mínimo de ' . zen_config('ENTRY_FIRST_NAME_MIN_LENGTH') . ' caracteres.',
    ...
    'ENTRY_LAST_NAME_ERROR' => 'Los apellidos debe tener un mínimo de ' . zen_config('ENTRY_LAST_NAME_MIN_LENGTH') . ' caracteres.',
    ...
    'ENTRY_PASSWORD_ERROR' => 'La contraseña debe tener un mínimo de ' . zen_config('ENTRY_PASSWORD_MIN_LENGTH') . ' caracteres.',
    ...
    'ENTRY_PASSWORD_NEW_ERROR' => 'La nueva contraseña debe tener un mínimo de ' . zen_config('ENTRY_PASSWORD_MIN_LENGTH') . ' caracteres.',
    ...
    'ENTRY_PASSWORD_TEXT' => '* (al menos ' . zen_config('ENTRY_PASSWORD_MIN_LENGTH') . ' caracteres)',
    'ENTRY_POST_CODE' => 'Código Postal:',
    'ENTRY_POST_CODE_ERROR' => 'El código postal debe tener un mínimo de ' . zen_config('ENTRY_POSTCODE_MIN_LENGTH') . ' caracteres.',
    ...
    'ENTRY_STATE_ERROR' => 'La provincia debe tener un mínimo de ' . zen_config('ENTRY_STATE_MIN_LENGTH') . ' caracteres.',
    'ENTRY_STATE_ERROR_SELECT' => 'Por favor, seleccione una provincia del menú desplegable.',
    'ENTRY_STATE_TEXT' => '*',
    'ENTRY_STREET_ADDRESS' => 'Dirección:',
    'ENTRY_STREET_ADDRESS_ERROR' => 'La dirección debe tener un mínimo de ' . zen_config('ENTRY_STREET_ADDRESS_MIN_LENGTH') . ' caracteres.',
    'ENTRY_STREET_ADDRESS_TEXT' => '*',
    'ENTRY_SUBURB' => 'Dirección (cont.):',
    'ENTRY_SUBURB_TEXT' => '',
    'ENTRY_TELEPHONE_NUMBER' => 'Teléfono:',
    'ENTRY_TELEPHONE_NUMBER_ERROR' => 'El teléfono debe tener un mínimo de ' . zen_config('ENTRY_TELEPHONE_MIN_LENGTH') . ' números.',
    ...
    'FEMALE' => 'Sra.',
    'FOOTER_TEXT_BODY' => 'Todo los Derechos Reservados &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '">' . zen_config('STORE_OWNER') . '</a>. <a href="https://www.zen-cart.com" rel="noopener noreferrer" target="_blank">Ecomercio Zen Cart</a>',
    ...
    'JS_REVIEW_TEXT' => '* El \'texto del comentario\' debe tener al menos ' . zen_config('REVIEW_TEXT_MIN_LENGTH') . ' caracteres.',
    ...
    'OUT_OF_STOCK_CANT_CHECKOUT' => 'Los productos marcados <b>' . zen_config('STOCK_MARK_PRODUCT_OUT_OF_STOCK') . '</b> no tienen stock o no hay suficientes para completar su pedido.<br>Cambie la cantidad de los productos marcados con (' . zen_config('STOCK_MARK_PRODUCT_OUT_OF_STOCK') . '). Gracias',
    ...
    'PRODUCT_PRICE_WHOLESALE' => 'Precio Mayorista:&nbsp;',
    ...
    'TEXT_COUPON_HELP_DATE' => 'Este cupón es válido entre %1$s y %2$s',
    ...
    'TEXT_DISPLAY_NUMBER_OF_ORDERS' => 'Mostrando de <strong>%1$d</strong> al <strong>%2$d</strong> (de <strong>%3$d</strong> Pedidos)',
    'TEXT_DISPLAY_NUMBER_OF_PRODUCTS' => 'Mostrando de <strong>%1$d</strong> al <strong>%2$d</strong> (de <strong>%3$d</strong> Productos)',
    'TEXT_DISPLAY_NUMBER_OF_PRODUCTS_ALL' => 'Mostrando de <strong>%1$d</strong> al <strong>%2$d</strong> (de <strong>%3$d</strong> Products)',
    'TEXT_DISPLAY_NUMBER_OF_PRODUCTS_FEATURED_PRODUCTS' => 'Mostrando de <strong>%1$d</strong> al <strong>%2$d</strong> (de <strong>%3$d</strong> Productos Destacados)',
    'TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW' => 'Mostrando de <strong>%1$d</strong> al <strong>%2$d</strong> (de <strong>%3$d</strong> Productos Nuevos)',
    'TEXT_DISPLAY_NUMBER_OF_REVIEWS' => 'Mostrando de <strong>%1$d</strong> al <strong>%2$d</strong> (de <strong>%3$d</strong> Comentarios)',
    'TEXT_DISPLAY_NUMBER_OF_SPECIALS' => 'Mostrando de <strong>%1$d</strong> al <strong>%2$d</strong> (de <strong>%3$d</strong> Ofertas)',
    ...
    'TEXT_NO_SHIPPING_AVAILABLE_ESTIMATOR' => 'No hay una opción de envío disponible para esta dirección.<br><br>Entre en su cuenta o contáctenos para opciones alternativas.',
    ...
    'TEXT_UNKNOWN_ORDERS_STATUS_NAME' => 'Desconocido (%u)',   //- %u is filled in by the Customer class to contain the missing orders_status_id
