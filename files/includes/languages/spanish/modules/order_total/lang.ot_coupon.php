...
$define = [
    ...
    'MODULE_ORDER_TOTAL_COUPON_REDEEM_INSTRUCTIONS' => '<p>Escriba el código de su cupón en la casilla "Código del Cupón".<br>El cupón se aplicará cuando pulse en "Siguiente" (sólo puede usarse <b>un</b> cupón por pedido).</p>',
