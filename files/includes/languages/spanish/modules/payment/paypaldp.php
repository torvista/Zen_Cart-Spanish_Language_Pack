...
'<font color="green"><hr><strong>Requisitos:</strong></font><br><hr>*<strong>Express Checkout</strong> debe ser instalado y activado para usar PayPal Payments Pro, de acuerdo con las condiciones de servicio de PayPal. <br>*También precisa CURL con SLL para comunicar con PayPal. Hay que habilitar CURL para las puertas 80 y 443. <hr />' );
  ...
  define('MODULE_PAYMENT_PAYPALDP_TEXT_JS_CC_CVV', '* Tecle el número de 3 o 4 dígitos de la cara trasera de la tarjeta.\n');
  ...
  define('MODULE_PAYMENT_PAYPALDP_TEXT_TRY_OTHER_PAYMENT_METHOD', 'PayPal ha rechazado el cobro de la fuente de fondos elegida. Elige otro tipo de pago de su cuenta Paypal o un método de pago alternativo. ');
  ...
  if (!defined('MODULE_PAYMENT_PAYPALWPP_TEXT_VOID_CONFIRM_CHECK')) define('MODULE_PAYMENT_PAYPALWPP_TEXT_VOID_CONFIRM_CHECK', 'Confirmar');
  if (!defined('MODULE_PAYMENT_PAYPALDP_TEXT_VOID_CONFIRM_ERROR')) define('MODULE_PAYMENT_PAYPALDP_TEXT_VOID_CONFIRM_ERROR', 'Solicitó una cancelación pero no marcó la casilla de confirmación.');
  if (!defined('MODULE_PAYMENT_PAYPALWPP_TEXT_AUTH_FULL_CONFIRM_CHECK')) define('MODULE_PAYMENT_PAYPALWPP_TEXT_AUTH_FULL_CONFIRM_CHECK', 'Confirmar');
  if (!defined('MODULE_PAYMENT_PAYPALDP_TEXT_AUTH_CONFIRM_ERROR')) define('MODULE_PAYMENT_PAYPALDP_TEXT_AUTH_CONFIRM_ERROR', 'Solicitó un autorización pero no marcó la casilla de confirmación.');
  ...
  define('MODULE_PAYMENT_PAYPALDP_TEXT_REFUND_INITIATED', 'Devolución PayPal para %s iniciada. ID Transacción: %s. Refresque la pantalla para ver los detalles de confirmación actualizados en el apartado Historial de Estado de Pedido/Comentario.');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_AUTH_INITIATED', 'Autorización PayPal para %s iniciada. Refresque la pantalla para ver los detalles de confirmación actualizados en el apartado Historial de Estado de Pedido/Comentario.');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CAPT_INITIATED', 'Captura PayPal para %s iniciada. ID Comprobante: %s. Refresque la pantalla para ver los detalles de confirmación actualizados en el apartado Historial de Estado de Pedido/Comentario.');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_VOID_INITIATED', 'Petición PayPal de Cancelación iniciada. ID Transacción: %s. Refresque la pantalla para ver los detalles de confirmación actualizados en el apartado Historial de Estado de Pedido/Comentario.');
  ...
  if (!defined('MODULE_PAYMENT_PAYPALDP_TEXT_CAPTURE_FULL_CONFIRM_CHECK')) define('MODULE_PAYMENT_PAYPALDP_TEXT_CAPTURE_FULL_CONFIRM_CHECK','Confirmar: ');
  ...
  if (!defined('MODULES_PAYMENT_PAYPALWPP_LINEITEM_TEXT_ONETIME_CHARGES_PREFIX')) define('MODULES_PAYMENT_PAYPALWPP_LINEITEM_TEXT_ONETIME_CHARGES_PREFIX', 'Cargos únicos relacionados a ');
