...
define('MODULE_PAYMENT_PAYPAL_ENTRY_FIRST_NAME', 'Nombre');
  ...
  define('MODULE_PAYMENT_PAYPAL_ENTRY_REFUND_SUFFIX', '* No está permitido solicitar una devolución total después de tramitar una devolución parcial. <br />* Devoluciones parciales múltiples están permitidas hasta el valor total del pedido.');
