...
$define = [
    ...
    'MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_OWNER' => '* El nombre del propietario de la tarjeta debe tener al menos ' . zen_config('CC_OWNER_MIN_LENGTH') . ' caracteres.\n',
    'MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_NUMBER' => '* El número de la tarjeta de crédito debe tener al menos ' . zen_config('CC_NUMBER_MIN_LENGTH') . ' caracteres.\n',
