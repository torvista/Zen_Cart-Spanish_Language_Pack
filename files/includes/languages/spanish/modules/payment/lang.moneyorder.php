...
$define = [
    ...
    'MODULE_PAYMENT_MONEYORDER_TEXT_DESCRIPTION' => 'Clientes puede enviar su pago por correos. Su email de confirmación del pedido le pedirá que <br><br>Por favor, remita su cheque o giro postal a:<br>' . (defined('MODULE_PAYMENT_MONEYORDER_PAYTO') ? zen_config('MODULE_PAYMENT_MONEYORDER_PAYTO') : '<br>(nombre de la tienda)') . '<br><br>Envie su pago a:<br>' . nl2br(zen_config('STORE_NAME_ADDRESS'), false). '<br><br>' . 'El pedido no será enviado hasta que el pago sea recibido.',
