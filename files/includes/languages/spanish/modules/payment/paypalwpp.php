...
'<font color="green"><hr /><strong>Requirements:</strong></font><br /><hr />*<strong>CURL</strong> is used for outbound communication with the gateway over ports 80 and 443, so must be active on your hosting server and able to use SSL.<br /><hr />' );
  ...
  if (!defined('MODULE_PAYMENT_PAYPALWPP_TEXT_VOID_CONFIRM_ERROR')) define('MODULE_PAYMENT_PAYPALWPP_TEXT_VOID_CONFIRM_ERROR', 'You requested to void a transaction but did not check the Confirm box to verify your intent.');
  ...
  if (!defined('MODULE_PAYMENT_PAYPALWPP_TEXT_AUTH_CONFIRM_ERROR')) define('MODULE_PAYMENT_PAYPALWPP_TEXT_AUTH_CONFIRM_ERROR', 'You requested an authorization but did not check the Confirm box to verify your intent.');
...
////////////////////////////////////////
  ...
  if (!defined('MODULE_PAYMENT_PAYPALWPP_ENTRY_PROTECTIONELIG')) define('MODULE_PAYMENT_PAYPALWPP_ENTRY_PROTECTIONELIG', 'Protection Eligibility:');
  ...
  if (!defined('MODULE_PAYMENT_PAYPALWPP_TEXT_CAPTURE_FULL_CONFIRM_CHECK')) define('MODULE_PAYMENT_PAYPALWPP_TEXT_CAPTURE_FULL_CONFIRM_CHECK','Confirm: ');
...
// this text is used to announce the username/password when the module creates the customer account and emails data to them:
  if (!defined('EMAIL_EC_ACCOUNT_INFORMATION')) define('EMAIL_EC_ACCOUNT_INFORMATION', 'Your account login details, which you can use to review your purchase, are as follows:');
