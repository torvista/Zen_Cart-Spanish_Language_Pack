...
$define = [
    ...
    'SUCCESS_PASSWORD_SENT' => 'Gracias. Si esa dirección de correo electrónico existe en nuestro sistema, le enviaremos instrucciones de recuperación de contraseña a esa dirección.',
];
