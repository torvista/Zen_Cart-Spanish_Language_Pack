...
Una vez que lo haya adquirido, el valor del ' . TEXT_GV_NAME . ' se sumará a su Cuenta de
  ...
  que la cantidad ahora se muestra en el Carro de Compras, y también se mostrará un enlace a la página donde podrá enviar el ' . TEXT_GV_NAME . ' a alguien por email.');
  break;
  case '2':
