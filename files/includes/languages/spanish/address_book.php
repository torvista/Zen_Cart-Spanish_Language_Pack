...
define('PRIMARY_ADDRESS_DESCRIPTION', 'Esta dirección se utiliza como la dirección preseleccionada para el envío y el pago de los pedidos hechos en esta tienda.<br /><br />También se usa como base para el cálculo de servicios e impuestos.');
