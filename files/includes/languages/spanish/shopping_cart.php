...
define('NAVBAR_TITLE', 'Cesta de Compra');
define('HEADING_TITLE', 'Su cesta de compra contiene:');
define('HEADING_TITLE_EMPTY', 'Su cesta de compra');
define('TEXT_INFORMATION', '');
define('TABLE_HEADING_REMOVE', 'Quitar');
define('TABLE_HEADING_QUANTITY', 'Cant.');
define('TABLE_HEADING_MODEL', 'Modelo');
define('TABLE_HEADING_PRICE', 'Precio');
define('TEXT_CART_EMPTY', 'Su cesta de compra está vacía.');
