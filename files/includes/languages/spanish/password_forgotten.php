...
define('SUCCESS_PASSWORD_SENT', 'Gracias. Si el email existe en la base de datos, enviaremos instrucciones como resetear la contraseña.');

define('SUCCESS_PASSWORD_SENT', 'Acabamos de enviar a su email una nueva contraseña.');
define('EMAIL_ADDRESS_NOT_FOUND', 'Discuple, el email no existe en la base de datos.');
