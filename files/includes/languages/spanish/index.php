...
// Showcase vs Store
if (STORE_STATUS == '0') {
  define('TEXT_GREETING_GUEST', '¡Bienvenido/a <span class="greetUser">Invitado/a</span>! ¿Quiere <a href="%s">identificarse</a> o <a href="%s">crear una cuenta nueva</a>?');
} else {
...
if ( ($category_depth == 'products') || (zen_check_url_get_terms()) ) {
  ...
  define('HEADING_TITLE', '¡Enhorabuena! Ha instalado su tienda Zen Cart con éxito.');
