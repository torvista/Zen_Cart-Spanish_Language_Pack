...
$define = [
    ...
    'TEXT_INFORMATION' => '<p>Si estaba realizando un pedido, por favor identifíquese de nuevo y su carro de la compra será recuperado. Deberá volver a realizar el pago y completar su última compra. </p><p>Si completó su pedido y desea revisarlo' . (zen_config('DOWNLOAD_ENABLED') === 'true' ? ', o tiene una descarga y desea completarla' : '') . ', por favor, vaya a <a href="' . zen_href_link(FILENAME_ACCOUNT) . '">Mi Cuenta</a> para visualizar su pedido.</p>',
