...
// javascript messages
  ...
  define('TEXT_CONDITION', 'Estado: ');
  define('TEXT_CONDITION_NEW', 'Nuevo');

  define('TEXT_IN_STOCK', 'En Stock');
  define('TEXT_OUT_OF_STOCK', 'Sin Stock');
  define('TEXT_INSTORE_ONLY', 'Solamente En Tienda');
  define('TEXT_PREORDER', 'Pedir con Antelación');
  ...
  define('PREVNEXT_BUTTON_FIRST', '&laquo;PRIMERA');
  define('PREVNEXT_BUTTON_PREV', '[&laquo;&nbsp;Anterior]');
  define('PREVNEXT_BUTTON_NEXT', '[Siguiente&nbsp;&raquo;]');
  define('PREVNEXT_BUTTON_LAST', 'ÚLTIMA&gt;&raquo;');
  define('PREVNEXT_TEXT_BACK', 'Volver al Listado');

  define('TEXT_BASE_PRICE', 'Desde: ');
  define('TEXT_PRICE_HEADING','Precio:');
  define('TEXT_DISCOUNTS_HEADING','Descuentos:');

  define('TEXT_CLICK_TO_ENLARGE', 'Ampliar imagen');
  define('TEXT_NO_IMAGE_AVAILABLE', 'No hay imagen disponible');
...
// payment method is GV/Discount
  ...
  define('TEXT_INVALID_COUPON_ORDER_LIMIT', 'Este código de cupón no es válido para clientes con más que %s pedido(s).');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_ALL_PRODUCTS','Todos los Products');
