...
//coupon redeem error messages (checkout payment)
  ...
  define('TEXT_INVALID_USES_COUPON', 'El Cupón "%1$s" ya ha sido utilizado la máximo número de veces (%2$u).');
...
// only for where multiple add to cart is used:
  ...
  define('FAILED_TO_ADD_UNAVAILABLE_PRODUCTS', 'Los productos seleccionados no están disponible para comprar actualmente...');
