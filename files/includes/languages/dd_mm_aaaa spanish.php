 ...
 * @version $Id: spanish.php from english.php 15514 2010-02-18 07:27:05Z drbyte $
 */
...
// shopping_cart box text in sideboxes/shopping_cart.php
  ...
  define('BOX_SHOPPING_CART_EMPTY', 'No hay artículos en la cesta');
...
// wishlist box text in includes/boxes/wishlist.php
 ...
 define('BOX_WISHLIST_EMPTY', 'No tiene ningún artículo en sus favoritos');
 define('IMAGE_BUTTON_ADD_WISHLIST', 'Añadir a favoritos');
 define('TEXT_WISHLIST_COUNT', 'Actualmente %s artículos están en sus favoritos.');
 define('TEXT_DISPLAY_NUMBER_OF_WISHLIST', 'Mostrando <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> artículos de sus favoritos)');
...
// constants for use in zen_prev_next_display function
  ...
  define('WARNING_INSTALL_DIRECTORY_EXISTS', 'Advertencia: El directorio de la instalación existe en: %s. Por favor elimine este directorio por razones de seguridad.');
  ...
  define('WARNING_SESSION_DIRECTORY_NON_EXISTENT', 'Advertencia: la carpeta de sesión no existe: ' . zen_session_save_path() . '. Las sesiones no funcionarán hasta que se cree este directorio.'); 
  define('WARNING_SESSION_DIRECTORY_NOT_WRITEABLE', 'Advertencia: no se puede escribir en la carpeta de sesión: ' . zen_session_save_path() . '. Las sesiones no funcionarán hasta que se fijen los permisos derechos del usuario.');
  ...
  define('ERROR_REDEEMED_AMOUNT', 'Enhorabuena, ha canjeado correctamente su cupón ');
...
// payment method is GV/Discount
  ...
  define('TEXT_INVALID_COUPON_PRODUCT', 'El código del cupón no es válido para ningún producto de los que están en su cesta`');
...
// for all pages except where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCT', 'El producto ha sido añadido correctamente a la cesta ...');
// only for where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCTS', 'El producto(s) seleccionado ha sido añadido correctamente a la cesta ...');
...
// End iii added
  ...
  define('TEXT_INVALID_SELECTION',' cual no es un opción válida. Inténtelo otra vez. ');
  define('TEXT_ERROR_OPTION_FOR', ' Seleccionó ');
...
// product_listing
  ...
  define('TEXT_PRODUCTS_MIX_OFF','*Mezclado HABILITADO');
  define('TEXT_PRODUCTS_MIX_ON','*Mezclado DESHABILITADO');
  ...
  define('ERROR_MAXIMUM_QTY', 'La cantidad añadida a la cesta ha sido modificada - hay una restricción del máximo permitido. Ver este producto: ');
  define('ERROR_CORRECTIONS_HEADING', 'Por favor corrija lo siguiente: <br />');
  define('ERROR_QUANTITY_ADJUSTED', 'La cantidad añadida a la cesta ha sido ajustada - El producto requerido no está disponible en cantidades fraccionadas. La cantidad de este producto es: ');
...
// shopping cart errors
  define('ERROR_PRODUCT', 'El producto: ');
  define('ERROR_PRODUCT_STATUS_SHOPPING_CART','<br />Lo sentimos pero este producto ha sido retirado de nuestro inventario.<br />Este producto ha sido retirado de su cesta. Contáctenos para más información.');
  ...
  define('WARNING_SHOPPING_CART_COMBINED', 'NOTICE: Para su comodidad, en la cesta permanecen los productos añadidos en su última visita. Por favor, revise su cesta antes de finalizar la sesión.');
...
// Shipping Estimator
  ...
  define('CART_ITEMS', 'Artículo(s) en la cesta: ');
  ...
  define('EMPTY_CART_TEXT_NO_QUOTE', '¡Lo siento! ha excedido el tiempo de su sesión ... Por favor, actualice su cesta para obtener el presupuesto de envío ...');
...
define('TEXT_HEADER_DISCOUNT_PRICES_ACTUAL_PRICE', 'Descuentos al por mayor Precio Nuevo');
define('TEXT_HEADER_DISCOUNT_PRICES_AMOUNT_OFF', 'Descuentos al por mayor');
define('TEXT_FOOTER_DISCOUNT_QUANTITIES', '* Los descuentos puede variar en función de las opciones anteriores');
define('TEXT_HEADER_DISCOUNTS_OFF', 'Descuentos al por mayor no disponibles ...');
...
// downloads module defines
  define('TABLE_HEADING_DOWNLOAD_DATE', 'este enlace caduca');
