...
//find_locales.php by torvista
 $version = 'v1.0';
/** This utility is intended to be used to check what locales are installed on this server and so what locale you may put in the main language constants file (the equivalent to english.php)
 *
 * USAGE INSTRUCTIONS:
 * 1. Open your browser
...
<h1>Find Locales - <?php echo $version; ?></h1>
...
if (!stristr(PHP_OS, "win")) { ?>
    ...
    <p> Quote from Microsoft <a href="https://msdn.microsoft.com/en-us/library/x99tb11d.aspx" target="_blank">here</a>.</p>
        <blockquote>"The locale argument can take a locale name, a language string, a language string and country/region code, a code
        ...
        <strong>If you provide a code page value of UTF-7 or UTF-8, setlocale will fail, returning NULL</strong>."</blockquote>
    <?php
}
