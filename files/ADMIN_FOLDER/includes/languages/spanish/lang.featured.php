...
$define = [
    ...
    'WARNING_FEATURED_PRE_ADD_PID_EMPTY' => 'Aviso: No se especificó el ID del producto.',
    'WARNING_FEATURED_PRE_ADD_PID_DUPLICATE' => 'Aviso: ID#%u producto ya está en Destacados.',
    'WARNING_FEATURED_PRE_ADD_PID_NO_EXIST' => 'Aviso: El ID#%u producto no existe.',
