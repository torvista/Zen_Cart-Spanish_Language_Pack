...
$define = [
    ...
    'TEXT_INFO_DATABASE_OPTIMIZE' => '<strong>Optimizar base de datos</strong> para quitar el espacio de registros borrados.<br>Se recomienda hacerlo mensual o semanalmente en una tienda con mucho movimiento (Es recomendable optimizar la base de datos en horario de poca afluencia de visitantes).',
    'TEXT_INFO_OPTIMIZING_DATABASE_TABLES' => 'Optimización de la base de datos está en marcha. Puede tardar unos minutos. Espera por favor. El menú anterior aparecerá cuando esté terminado ... ',
    'SUCCESS_DB_OPTIMIZE' => 'Optimización de la base de datos - Tablas procesadas: ',
    'TEXT_INFO_PURGE_DEBUG_LOG_FILES' => '<strong>Borrar archivos Debug</strong><br><strong>¡Precaución!: </strong>Zen Cart archiva los mensajes de errores PHP para ayudar en solucionar problemas, y muchos de los módulos de pago pueden crear archivos log para diagnosticar problemas de comunicación.<br>Esta función borrará *TODOS* los archivos Debug asociados con errores PHP y los módulos de pago de la carpeta /logs.',
