...
define('HEADER_TITLE_TOP', 'Admin Inicio');
...
define('BOX_CONFIGURATION_IMAGES', 'Imagenes');
...
define('BOX_CONFIGURATION_ATTRIBUTE_OPTIONS', 'Opciones de Attributos');
...
define('BOX_CONFIGURATION_WEBSITE_MAINTENANCE', 'Mantenimiento del Web');
...
define('BOX_ADMIN_ACCESS_LOGS', 'Archivos de Actividad Admin');
...
define('IMAGE_PRODUCTS_TO_CATEGORIES', 'Administrador de enlaces de categorías múltiples');
...
define('TEXT_ATTRIBUTES_QTY_PRICES_HELP', 'Descuentos por Cant. de opciones');
define('TABLE_ATTRIBUTES_QTY_PRICE_QTY','Cant.');
define('TABLE_ATTRIBUTES_QTY_PRICE_PRICE','PRECIO');
define('TEXT_ATTRIBUTES_QTY_PRICES_ONETIME_HELP', 'Cobros únicos por descuentos por Cant. de opciones');
...
define('ERROR_NO_DATA_TO_SAVE', 'ERROR: Datos vacios. SUS CAMBIOS *NO* HAN SIDO GUARDADOS. Posiblemente hay un problema con su navegador o su conexión del internet.');
define('TEXT_HIDDEN', 'Ocultados');
