...
define('SUCCESS_PAGE_STATUS_UPDATED', 'Éxito. El estatus de la página ha sido actualizado.');
...
define('TEXT_CHAPTER', 'Prev/Prox Capítulo:');
...
define('TEXT_CHAPTER_EXPLAIN', 'Se usa <strong>Capítulo</strong> con un TdC (Tabla de Contenidos) Orden para los enlaces Previo/Próximo. Los enlaces del TdC consisten de las páginas que tienen esta número de capítulo and se las ve en el TdC Orden.');
...
define('TEXT_SORT_PAGE_TITLE', 'Page Título');
