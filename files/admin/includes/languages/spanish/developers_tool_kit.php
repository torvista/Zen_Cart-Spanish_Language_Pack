 ...
 */
  ...
  define('TEXT_INFO_CONFIGURATION_UPDATE', '<strong>NOTA:</strong> Las CONSTANTES se escriben en mayúscula.<br />Búsquedas de archivo de idioma, funciones, clases, etc. se realizan cuando no se ha encontrado nada en las tablas de bases de datos, si se selecciona en la lista desplegable');
  ...
  define('TEXT_ALL_FILES_LOOKUP_PHP', '.php sóla');
  ...
  define('TEXT_ALL_FILES_LOOKUP_JS', '.js solamente');
