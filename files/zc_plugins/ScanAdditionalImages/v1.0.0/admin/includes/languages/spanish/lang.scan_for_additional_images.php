...
1) Directamente en la página de edición del producto, un producto a la vez, donde puede asignar (y eliminar) una imagen adicionales, sin preocuparse por el nombre del archivo ni cambiar el nombre de las imágenes para que conformen a un patrón. Esto requiere que la configuración de <strong>Admin-&gt;Configuration-&gt;Images-&gt;Additional Images filename matching pattern</strong> esté establecida en <strong>Database</strong>.<br>
2) Mediante FTP, nombrando todos las imágenes adicionales según una <a href="https://docs.zen-cart.com/user/images/image_filename_conventions/" target="_blank">convención de nomenclatura</a> prescrita. Así se muestran las imágenes adicionales automáticamente junto con la imagen principal.<br><br>
