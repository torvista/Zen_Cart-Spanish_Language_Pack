...
define('WARNING_COPY_ALL_PRODUCTS_TO_CATEGORY_TO_LINKED_MISSING', 'AVISO: Copia completado a Categoría Inválido: ');
...
define('WARNING_MASTER_CATEGORIES_ID_CONFLICT', '<strong>ATENCIÓN: ¡¡CONFLICTO DE ID DE CATEGORÍAS MAESTRAS!! </strong>');
define('TEXT_INFO_MASTER_CATEGORIES_ID_CONFLICT', '<strong>El ID de Categoría Maestra es: </strong>');
define('TEXT_INFO_MASTER_CATEGORIES_ID_PURPOSE', 'NOTA: La Categoría Maestra se utiliza para modificar el precio cuando la categoría influye en los precios de productos enlazados, por ejemplo en la categoría \"Especiales\"<br />');
