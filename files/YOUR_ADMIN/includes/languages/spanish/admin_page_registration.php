...
define('TEXT_PAGE_KEY', 'Clave de la Página');
...
define('ERROR_LANGUAGE_KEY_NOT_ENTERED', 'Precisa una clave de idioma. Todas las páginas del Admin deben tener una clave de idioma que define el texto en cualquier enlace del menu.');
define('ERROR_LANGUAGE_KEY_HAS_NOT_BEEN_DEFINED', 'La clave de idioma no ha sido definido. Por favor, compruebe que está escrita correctamente.');
define('ERROR_MAIN_PAGE_NOT_ENTERED', 'El nombre del archivo de la página no ha sido definido.');
define('ERROR_FILENAME_HAS_NOT_BEEN_DEFINED', 'La definición del nombre del archivo que ha puesto no existe. Por favor compruebe que está escrito correctamente.');
