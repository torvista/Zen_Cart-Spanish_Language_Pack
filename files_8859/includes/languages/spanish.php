...
@setlocale(LC_TIME, 'es_ES.ISO_8859-1');//unix, was @setlocale(LC_TIME, 'en_US.ISO_8859-1');
...
// product_listing
  ...
  define('PRODUCTS_QUANTITY_IN_CART_LISTING', 'En la carro:');
  ...
  define('ERROR_MAXIMUM_QTY', 'La cantidad añadida al carro ha sido modificada - hay una restricción del máximo permitido. Ver este producto: ');
  define('ERROR_CORRECTIONS_HEADING', 'Por favor corrija lo siguiente: <br />');
  define('ERROR_QUANTITY_ADJUSTED', 'La cantidad añadida al carro ha sido ajustada - El producto requerido no está disponible en cantidades fraccionadas. La cantidad de este producto es: ');
...
// shopping cart errors
  ...
  define('ERROR_PRODUCT_STATUS_SHOPPING_CART','<br />Lo sentimos pero este producto ha sido retirado de nuestro inventario.<br />Este producto ha sido retirado de su carro. Contáctenos para más información.');
  ...
  define('WARNING_SHOPPING_CART_COMBINED', 'NOTICE: Para su comodidad, en la carro permanecen los productos añadidos en su última visita. Por favor, revise su carro antes de finalizar la sesión.');
