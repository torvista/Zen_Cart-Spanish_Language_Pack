...
define('TEXT_CHECKOUT_LOGOFF_GUEST', 'NOTA: Para procesar su pedido, se ha creado una cuenta temporal. Se puede cerrar esa cuenta haciendo click en "Log Off". Adicionalmente "Salir" asegura de que la información sobre su factura y pedido no será visible para la próxima persona que utilice este ordenador. Si quiere seguir comprando ¡adelante! Puede salir en cualquier momento a través del enlace al principio de la página.');
define('TEXT_CHECKOUT_LOGOFF_CUSTOMER', '<p>¡Muchas gracias por su confianza!<br /> Haga un click en "Salir" para asegurarse de que la información sobre su factura y pedido no será visible para la próxima persona que utilice este ordenador.</p>');