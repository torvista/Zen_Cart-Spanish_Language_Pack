...
define('BOX_INFORMATION', 'Las cookies deben estar habilitadas para comprar online en esta tienda, esto es para garantizar la privacidad y la seguridad en su visita a este sitio.<br /><br />Habilitando el soporte para cookies en su navegador, la comunicación entre y usted este sitio se verá fortalecida para asegurar que es usted en persona quien hace las transacciones, y para prevenir el robo de su información privada.');
?>