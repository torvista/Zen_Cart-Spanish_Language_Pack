 ...
 */
  ...
  define('MODULE_PAYMENT_PAYPAL_TEXT_DESCRIPTION', '<strong>PayPal Website Payments Standard (IPN)</strong> (Servicio PayPal básico)<br /><a href="http://www.zen-cart.com/partners/paypal-std" target="_blank">Gestionar su cuenta PayPal.</a><br /><br /><font color="green">Configuración:</font><br />1. <a href="http://www.zen-cart.com/partners/paypal-std" target="_blank">Abra una cuenta PayPal aquí.</a><br />2. En su cuenta PayPal, en "Profile/Perfil",<ul><li>fije su <strong>Instant Payment Notification Preferences</strong> URL a:<br /><nobr><pre>'.str_replace('index.php?main_page=index','ipn_main_handler.php',zen_catalog_href_link(FILENAME_DEFAULT, '', 'SSL')) . '</pre></nobr><br />(Si hay otro URL válido está en el campo, déjelo.)<br /><span class="alert">¡Asegúrese de que la casilla para habilitar IPN está marcada!</span><br /><br /></li><li>en <strong>Website Payments Preferences</strong> fíje su <strong>Automatic Return URL</strong> a:<br /><nobr><pre>'.zen_catalog_href_link(FILENAME_CHECKOUT_PROCESS, '', 'SSL',false).'</pre></nobr></li>' . (defined('MODULE_PAYMENT_PAYPALSTD_STATUS') ? '' : '<li>... y pinche en "install" arriba para habilitar soporte PayPal... y  "edit" para decir a Zen Cart cuáles son sus parámetros PayPal.</li>') . '</ul><font color="green"><hr /><strong>Requesitos:</strong></font><br /><hr />*<strong>Cuenta PayPal </strong> (<a href="http://www.zen-cart.com/partners/paypal-std" target="_blank">pinche para abrir una cuenta</a>)<br />*<strong>Puerta 80</strong> es utilizada para comunicación con la puerta de enlace entonces hay que abrir esta puerta en el router y el cortafuegos <br />*<strong>Hay que configurar los parámetros</strong> como se describa arriba.' );
  ...
  define('MODULE_PAYMENT_PAYPAL_PURCHASE_DESCRIPTION_TITLE', STORE_NAME . ' Compra');
  define('MODULE_PAYMENT_PAYPAL_PURCHASE_DESCRIPTION_ITEMNUM', 'Comprobante de pago de la Tienda');
