...
define('TEXT_ARTIST_URL', 'Para más información, visite la <a href="%s" target="_blank">web oficial</a> de la artista.');
...
define('TEXT_PRODUCT_COLLECTIONS', 'Colección de media: ');
